import{z as l,U as z}from"./usertypes.276843e8.js";import{s as i,n as a}from"./scheduler.e108d1fd.js";import{S as m,i as v,g as c,h,y as u,k as o,a as g,f as k,j as y}from"./index.13e5c6dd.js";import{b as r}from"./paths.0418f812.js";const b=l.object({username:l.string().min(1,{message:"A felhasználónév nem lehet üres!"}).max(32,{message:"A felhasználónév nem lehet hosszabb 32 karakternél!"}),password:l.string().min(1,{message:"A jelszó nem lehet üres!"})});b.and(l.object({userType:l.nativeEnum(z)}));function f(n){let e,s=`<div class="row svelte-9mloko"><div class="col-6 svelte-9mloko"><h4 class="svelte-9mloko">Hírek</h4></div> <div class="col-3 svelte-9mloko"><h4 class="svelte-9mloko">Dokumentumok</h4></div> <div class="col-3 svelte-9mloko"><h4 class="svelte-9mloko">Hasznos linkek</h4></div> <div class="col-6 svelte-9mloko"><h5 class="svelte-9mloko">Elektronika a LIDL-ben</h5> <p class="svelte-9mloko">Fedezd fel a LIDL legújabb Elektronika kollekcióját, ami nemcsak divatos és kényelmes
