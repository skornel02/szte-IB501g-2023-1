import{z as a}from"./index.0ec66d4d.js";import{U as z}from"./usertypes.d012f79a.js";import{s as r,f as m,g as v,L as u,j as o,i as c,C as l,d as k,h as y}from"./scheduler.2c2a7c16.js";import{S as h,i as g}from"./index.cec4e112.js";import{b as i}from"./paths.5e87fca0.js";const b=a.object({username:a.string().min(1,{message:"A felhasználónév nem lehet üres!"}).max(32,{message:"A felhasználónév nem lehet hosszabb 32 karakternél!"}),password:a.string().min(1,{message:"A jelszó nem lehet üres!"})});b.and(a.object({userType:a.nativeEnum(z)}));function f(n){let e,s=`<div class="row svelte-9mloko"><div class="col-6 svelte-9mloko"><h4 class="svelte-9mloko">Hírek</h4></div> <div class="col-3 svelte-9mloko"><h4 class="svelte-9mloko">Dokumentumok</h4></div> <div class="col-3 svelte-9mloko"><h4 class="svelte-9mloko">Hasznos linkek</h4></div> <div class="col-6 svelte-9mloko"><h5 class="svelte-9mloko">Elektronika a LIDL-ben</h5> <p class="svelte-9mloko">Fedezd fel a LIDL legújabb Elektronika kollekcióját, ami nemcsak divatos és kényelmes
