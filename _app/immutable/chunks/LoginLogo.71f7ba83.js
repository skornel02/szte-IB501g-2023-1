import{z as a}from"./index.0ec66d4d.js";import{U as z}from"./usertypes.f975be66.js";import{s as i,n as l}from"./scheduler.572f10a3.js";import{S as m,i as v,g as c,h,I as u,k as o,a as g,f as k,j as y}from"./index.21ac587f.js";import{b as r}from"./paths.60bbcda8.js";const b=a.object({username:a.string().min(1,{message:"A felhasználónév nem lehet üres!"}).max(32,{message:"A felhasználónév nem lehet hosszabb 32 karakternél!"}),password:a.string().min(1,{message:"A jelszó nem lehet üres!"})});b.and(a.object({userType:a.nativeEnum(z)}));function f(n){let e,s=`<div class="row svelte-9mloko"><div class="col-6 svelte-9mloko"><h4 class="svelte-9mloko">Hírek</h4></div> <div class="col-3 svelte-9mloko"><h4 class="svelte-9mloko">Dokumentumok</h4></div> <div class="col-3 svelte-9mloko"><h4 class="svelte-9mloko">Hasznos linkek</h4></div> <div class="col-6 svelte-9mloko"><h5 class="svelte-9mloko">Elektronika a LIDL-ben</h5> <p class="svelte-9mloko">Fedezd fel a LIDL legújabb Elektronika kollekcióját, ami nemcsak divatos és kényelmes
